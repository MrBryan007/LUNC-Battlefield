/* LUNC Battlefield v9.4.8 — shared config (GitHub Pages safe) */
(function (global) {
  'use strict';
  ...
  const config = {
    BUILD: 'v9.4.8',
    TITLE: 'LUNC Ecosystem Battlefield v9.4.8 — non-JS/WebGL stall diagnostics — shared mats/shadows/LOD (WebGL r128)',
    DataTruth,
    tokens,
