/* LUNC Battlefield v9.4.5 — shared config (GitHub Pages safe) */
(function (global) {
  'use strict';
  ...
  const config = {
    BUILD: 'v9.4.5',
    TITLE: 'LUNC Ecosystem Battlefield v9.4.5 — performance recovery — shared mats/shadows/LOD stagger (WebGL r128)',
    DataTruth,
    tokens,
