/* LUNC Battlefield v9.4.4 — shared config (GitHub Pages safe) */
(function (global) {
  'use strict';
  ...
  const config = {
    BUILD: 'v9.4.4',
    TITLE: 'LUNC Ecosystem Battlefield v9.4.4 — tank silhouettes, denser armies, kinetic air combat (WebGL r128)',
    DataTruth,
    tokens,
