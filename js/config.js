/* LUNC Battlefield v9.4.11 — shared config (GitHub Pages safe) */
(function (global) {
  'use strict';
  ...
  const config = {
    BUILD: 'v9.4.11',
    TITLE: 'LUNC Ecosystem Battlefield v9.4.11 — jet attack choreography with runId-synced impacts (WebGL r128)',
    DataTruth,
    tokens,
